...
def summarize_node(state):
    ...
    SUMMARY_PROMPT="""
        ...
        1. You are a summarization assistant, in a langgraph based content research agent system. 
        ...
        7. The asnwer in the answer field of response should also contain respective citations next to each bullet point as e.g.: - summary point 1 [source: document_name, page: page_number]  
       
        8. No other text other than the summary points along with the error fallback message mentioned in point 5 should be there in the answer field of the response. Do not write any other text apart from that in the answer field.
    ...
    #invoke llm
    try:
        summary=llm.invoke(SUMMARY_PROMPT.format(context=context, query=state["query"]))
